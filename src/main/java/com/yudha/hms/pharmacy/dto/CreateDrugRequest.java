...
/**
 * Create Drug Request DTO.
 *
 * Request object for creating new drug.
 *
...
public class CreateDrugRequest {
    ...
    @Size(max = 50, message = "Drug code must not exceed 50 characters")
     ...
     * Drug unit
     */
    @NotNull(message = "Drug unit is required")
     ...
     * Formularium status
     */
    @NotNull(message = "Formularium status is required")
